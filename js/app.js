document.addEventListener('DOMContentLoaded', () => {
    ...
    // Update the payment instructions display
    window.updatePaymentInstructions = (method) => {
        const paymentInstructions = document.getElementById('payment-instructions');
        const transactionIdInput = document.getElementById('transaction-id');
        ...
        const instructions = {
            bkash: `
                <div class="space-y-2">
                    <p class="font-medium">bKash Payment Instructions:</p>
                    <p class="text-sm text-gray-600">Send money to: <span class="font-medium">${PAYMENT_NUMBERS.bkash}</span></p>
                    <ol class="list-decimal list-inside space-y-1 text-sm">
                        <li>Go to your bKash app or dial *247#</li>
                        <li>Choose "Send Money"</li>
                        <li>Enter the total amount shown above</li>
                        <li>Add a reference: Your Order ID</li>
            ...
            nagad: `
                <div class="space-y-2">
                    <p class="font-medium">Nagad Payment Instructions:</p>
                    <p class="text-sm text-gray-600">Send money to: <span class="font-medium">${PAYMENT_NUMBERS.nagad}</span></p>
                    <ol class="list-decimal list-inside space-y-1 text-sm">
            ...
            upay: `
                <div class="space-y-2">
                    <p class="font-medium">Upay Payment Instructions:</p>
                    <p class="text-sm text-gray-600">Send money to: <span class="font-medium">${PAYMENT_NUMBERS.upay}</span></p>
                    <ol class="list-decimal list-inside space-y-1 text-sm">
                        <li>Go to your Upay app or dial *268#</li>
                        <li>Choose "Send Money"</li>
                        <li>Enter the total amount shown above</li>
                        <li>Add a reference: Your Order ID</li>
                        <li>Enter your PIN to confirm</li>
